/**
 * Fetch historical and cultural places in Turkey's Aegean Region
...
const BOUNDING_BOX = 'rect:26,36,31,40';
const LIMIT = 100;
const REQUEST_DELAY_MS = 700;
const RETRY_DELAY_MS = 5000;
const OUTPUT_FILE = 'ege_historical_places.json';
...
async function fetchEgePlaces() {
  ...
  console.log('Starting fetch for Aegean Region historical places...');
