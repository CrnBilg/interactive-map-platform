/**
 * Fetch historical and cultural places in Turkey's Southeastern Anatolia Region
...
const BOUNDING_BOX = 'rect:35.5,36,42,39';
const LIMIT = 100;
const REQUEST_DELAY_MS = 700;
const RETRY_DELAY_MS = 5000;
const OUTPUT_FILE = 'guneydogu_anadolu_historical_places.json';
...
async function fetchGuneydoguAnadoluPlaces() {
  ...
  console.log('Starting fetch for Southeastern Anatolia historical places...');
...
if (require.main === module) {
  ...
  fetchGuneydoguAnadoluPlaces().catch(err => {
