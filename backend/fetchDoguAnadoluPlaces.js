/**
 * Fetch historical and cultural places in Turkey's Eastern Anatolia Region
...
const BOUNDING_BOX = 'rect:37,37,45,42';
const LIMIT = 100;
const REQUEST_DELAY_MS = 700;
const RETRY_DELAY_MS = 5000;
const OUTPUT_FILE = 'dogu_anadolu_historical_places.json';
...
async function fetchDoguAnadoluPlaces() {
  ...
  console.log('Starting fetch for Eastern Anatolia historical places...');
...
if (require.main === module) {
  ...
  fetchDoguAnadoluPlaces().catch(err => {
