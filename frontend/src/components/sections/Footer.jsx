...
import { CornerOrnament, MuseumIcon, Tughra } from '../visuals/Ornaments'
...
export default function Footer() {
  return (
    <footer className="lux-section border-t border-gold/20 bg-panel px-5 pb-8 pt-16 sm:px-8 lg:px-16">
      ...
      <div className="absolute bottom-0 left-0 z-[1] h-44 w-full bg-gradient-to-b from-transparent to-gold-deep/18" />
      <Skyline className="absolute bottom-0 left-0 z-[1] h-[150px] w-full opacity-90" />
      <Tughra className="absolute bottom-7 right-10 z-[2] h-[200px] w-[200px] opacity-80" />
